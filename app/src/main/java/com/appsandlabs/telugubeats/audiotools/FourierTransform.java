...
package com.appsandlabs.telugubeats.audiotools;
...
public abstract class FourierTransform
{
  ...
  protected void doWindow(byte[] samples)
  {
    switch (whichWindow)
    {
      case HAMMING:
  ...
  protected void hamming(byte[] samples)
  {
   ...
   */
  public abstract void forward(byte[] buffer);
  ...
  public void forward(float[] buffer, int startAt)
  {
    ...
    byte[] section = new byte[timeSize];
